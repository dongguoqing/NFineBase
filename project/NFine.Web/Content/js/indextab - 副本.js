(function ($) {
    $.tab = {
        ...
        refreshTab: function () {
            ...
            var target = $('._iframe[data-id="' + currentId + '"]');
        ...
        activeTab: function () {
            ...
            if (!$(this).hasClass('active')) {
                $('.mainContent ._iframe').each(function () {
                    if ($(this).data('id') == currentId) {
                        $(this).show().siblings('._iframe').hide();
                        return false;
                    }
                });
        ...
        closeOtherTabs: function () {
            $('.page-tabs-content').children("[data-id]").find('.fa-remove').parents('a').not(".active").each(function () {
                $('._iframe[data-id="' + $(this).data('id') + '"]').remove();
                $(this).remove();
            });
        ...
        addTab: function () {
            ...
            if (dataId != "") {
                top.$.cookie('_currentmoduleid', dataId, { path: "/" });
            }
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
                $('.mainContent').find('iframe._iframe').hide();
        ...
        init: function () {
            ...
            $('.tabCloseAll').on('click', function () {
                ...
                $('.page-tabs-content').children("[data-id]:first").each(function () {
                    $('._iframe[data-id="' + $(this).data('id') + '"]').show();
