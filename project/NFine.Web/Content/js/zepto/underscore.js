...
(function() {
  ...
  _.each = _.forEach = function(obj, iteratee, context) {
    ...
    iteratee = optimizeCb(iteratee, context);//function (value, index, collection)     //function(func, context, argCount) {      return function (value, index, collection) {  return func.call(context, value, index, collection);}
