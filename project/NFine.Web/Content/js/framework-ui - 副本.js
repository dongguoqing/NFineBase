...
//add by dgq  2014 新增数组去重方法  begin
//return array
...
//add by dgq 新增获取url参数
// paraName :参数的名称
$.getUrlParam = function getUrlPara(paraName) {//获取当前url参数值
...
//add by dgq 将时间的 json格式转换为字符串格式
//jsondate: json时间字符串
